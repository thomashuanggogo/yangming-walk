...
export const NPCS = [
  {
    ...
    dir: "down",
    dialog: [
      "早安！歡迎來到陽明里！山仔后這裡空氣好、文史豐富。",
      "我們全里分為中央山仔后、北區草山、西區美軍、東區建業與南區花卉五大生活圈。",
      "走訪全里 30 處特色地標並收集金幣，就能回到里辦公處領取榮譽里民證喔！"
    ]
  },
  {
    id: "npc_elder_wang",
    ...
    dir: "right",
    dialog: [
      "你現在走的美軍俱樂部這一帶，以前都是駐台美軍軍官居住的生活聚落。",
      "紅磚建築裡的壁爐、舞池與黑膠唱片都保留得非常好。",
      "往西邊走到底還可以到屋頂上欣賞台北盆地夕陽與夜景喔！"
    ]
  },
  {
    id: "npc_teacher_chen",
    ...
    dir: "down",
    dialog: [
      "同學你好！旁邊的花卉試驗中心是全台灣最大的茶花培育基地。",
      "春天賞櫻、秋天看銀杏、冬天賞茶花，一年四季都有不同的自然風貌。",
      "旁邊還有保佑山民百年的陽明福德宮，記得去合掌致意！"
    ]
  },
  {
    id: "npc_student_ken",
    ...
    dir: "right",
    dialog: [
      "呼！從山仔后一路漫步過來，就是我們文化大學大殿與大恩館了！",
      "後山仇人坡雖然風很大，但俯瞰台北盆地的夕陽真的是全台灣最美。",
      "走累的話，附近的美軍聚落有超多文青咖啡館與特色美食！"
    ]
  }
];
